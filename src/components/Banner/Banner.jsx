        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex flex-col justify-center gap-6 sm:pt-0">
            ...
            >
              ...
              nulla ad recusandae, commodi, incidunt dolorum temporibus
              doloribus optio saepe fuga maiores impedit repellat architecto
              nemo nobis explicabo error autem, sunt ipsam.
            </p>
